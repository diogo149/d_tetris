...
{{
var G__13220 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13220;
continue;
}
} else
...
{var pred__13224 = cljs.core._EQ_;var expr__13225 = limit;if(cljs.core.truth_(pred__13224.call(null,1,expr__13225)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13224.call(null,2,expr__13225)))
...
var G__13227 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13228 = (limit__$1 - 1);
var G__13229 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13227;
limit__$1 = G__13228;
parts = G__13229;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13231 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13231))
{var replacement_13232 = temp__4124__auto___13231;buffer.append([cljs.core.str(replacement_13232)].join(''));
} else
{buffer.append(ch);
}
{
