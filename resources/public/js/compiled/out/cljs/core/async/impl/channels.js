...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17549 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17549 = (function (val,box,meta17550){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17549.cljs$lang$type = true;
cljs.core.async.impl.channels.t17549.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17549";
cljs.core.async.impl.channels.t17549.cljs$lang$ctorPrWriter = (function (this__8450__auto__,writer__8451__auto__,opt__8452__auto__){return cljs.core._write.call(null,writer__8451__auto__,"cljs.core.async.impl.channels/t17549");
});
cljs.core.async.impl.channels.t17549.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17549.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17551){var self__ = this;
var _17551__$1 = this;return self__.meta17550;
});
cljs.core.async.impl.channels.t17549.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17551,meta17550__$1){var self__ = this;
var _17551__$1 = this;return (new cljs.core.async.impl.channels.t17549(self__.val,self__.box,meta17550__$1));
});
cljs.core.async.impl.channels.__GT_t17549 = (function __GT_t17549(val__$1,box__$1,meta17550){return (new cljs.core.async.impl.channels.t17549(val__$1,box__$1,meta17550));
});
}
return (new cljs.core.async.impl.channels.t17549(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_17552 = self__.takes.pop();if((taker_17552 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17552))
{var take_cb_17553 = cljs.core.async.impl.protocols.commit.call(null,taker_17552);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17553,taker_17552,this$__$1){
return (function (){return take_cb_17553.call(null,null);
});})(take_cb_17553,taker_17552,this$__$1))
);
} else
{}
{
