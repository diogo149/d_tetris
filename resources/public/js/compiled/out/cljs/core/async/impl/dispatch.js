...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17543 = 0;while(true){
var m_17544 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17544 == null))
{} else
{m_17544.call(null);
if((count_17543 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17545 = (count_17543 + 1);
count_17543 = G__17545;
continue;
}
} else
{}
