...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17452 = 0;while(true){
if((i_17452 < arr.length))
{(arr[i_17452] = null);
{
...
{var i_17459 = (self__.level + 1);while(true){
if((i_17459 <= (new_level + 1)))
{(update[i_17459] = self__.header);
{
var G__17460 = (i_17459 + 1);
i_17459 = G__17460;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17461 = 0;while(true){
if((i_17461 <= self__.level))
{var links_17462 = (update[i_17461]).forward;if(((links_17462[i_17461]) === x__$1))
{(links_17462[i_17461] = (x__$1.forward[i_17461]));
{
