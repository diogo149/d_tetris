...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__7883__auto__ = (w["requestAnimationFrame"]);if(cljs.core.truth_(or__7883__auto__))
{return or__7883__auto__;
} else
{var or__7883__auto____$1 = (w["webkitRequestAnimationFrame"]);if(cljs.core.truth_(or__7883__auto____$1))
{return or__7883__auto____$1;
} else
{var or__7883__auto____$2 = (w["mozRequestAnimationFrame"]);if(cljs.core.truth_(or__7883__auto____$2))
{return or__7883__auto____$2;
} else
{var or__7883__auto____$3 = (w["msRequestAnimationFrame"]);if(cljs.core.truth_(or__7883__auto____$3))
...
var n__8731__auto__ = a.length;var i = 0;while(true){
if((i < n__8731__auto__))
{var c_13212 = (a[i]);if(cljs.core.truth_((c_13212["cljsIsDirty"])))
{(c_13212["forceUpdate"])();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__8450__auto__,writer__8451__auto__,opt__8452__auto__){return cljs.core._write.call(null,writer__8451__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(c){var G__13215 = c;var G__13215__$1 = (((G__13215 == null))?null:(G__13215["props"]));var G__13215__$2 = (((G__13215__$1 == null))?null:(G__13215__$1["argv"]));return G__13215__$2;
});
...
reagent.impl.batching.dispose = (function dispose(c){var G__13217_13218 = (c["cljsRatom"]);var G__13217_13219__$1 = (((G__13217_13218 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__13217_13218));return reagent.impl.batching.mark_rendered.call(null,c);
});
